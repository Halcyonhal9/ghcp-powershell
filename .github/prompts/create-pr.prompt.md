...
Arguments: ${input:arguments:Optional extra context for the PR (branch name, focus areas, etc.)}
...
- Use the GitHub MCP tools to check for an existing PR on this branch and create or update accordingly.
