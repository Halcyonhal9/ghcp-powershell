...
Review pull request #${input:pr_number:The PR number to review} thoroughly and post a review with inline comments.

## Steps

1. **Fetch PR metadata and diff**:
   - Use the GitHub MCP tools to get the PR title, description, base branch, and diff.
...
5. **Post the review** using the GitHub MCP tools to submit a pull request review with:
